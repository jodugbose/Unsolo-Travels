...
public class KycController {
    ...
    public ResponseEntity<String> verifyNIN(@PathVariable(value = "nin_id") String ninId) throws InvalidNinValidationException,IllegalArgumentException, UserAlreadyExistException{
